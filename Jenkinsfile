    ...
    stages {
        stage('Build') {
            steps {
                ...
                bat 'shift'
                bat 'node "D:/Program Files (x86)/Graphviz2.38/node_modules/sqleton/bin/sqleton" -o %date:~6,8%+%time:~6,8%+"outhistorysqleton.svg" "C:/Users/qabuild/.ipython/profile_default/history.sqlite"'
            }
        }
    }
}