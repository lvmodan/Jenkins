    ...
    stages {
        stage('Build') {
            steps {
                ...
                bat 'shift'
                bat 'node "D:/Program Files (x86)/Graphviz2.38/node_modules/sqleton/bin/sqleton" -o outhistorysqleton.svg "C:/Users/qabuild/.ipython/profile_default/history.sqlite"'
            }
        }
    }
}